...
/*
 * Init and run calls for Mysecond flight mode
 */

// Mysecond - initialise loiter controller
bool ModeMysecond::init(bool ignore_checks)
{
...
#if PRECISION_LANDING == ENABLED
bool ModeMysecond::do_precision_loiter()
{
...
void ModeMysecond::precision_loiter_xy()
{
    loiter_nav->clear_pilot_desired_acceleration();
...
void ModeMysecond::run()
{
    ...
    //target_pitch = 2000;
    //printf("target_pitch%f",target_pitch);
...
uint32_t ModeMysecond::wp_distance() const
{
    return loiter_nav->get_distance_to_target();
}

int32_t ModeMysecond::wp_bearing() const
{
