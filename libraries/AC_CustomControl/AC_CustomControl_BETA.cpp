...
#if CUSTOMCONTROL_BETA_ENABLED

// table of user settable parameters
const AP_Param::GroupInfo AC_CustomControl_BETA::var_info[] = {
    // @Param: ANG_RLL_P
    ...
    // @User: Standard
    AP_SUBGROUPINFO(_p_angle_roll2, "ANG_RLL_", 1, AC_CustomControl_BETA, AC_P),
    ...
    // @Range{Sub}: 0.0 12.000
    // @User: Standard
    AP_SUBGROUPINFO(_p_angle_pitch2, "ANG_PIT_", 2, AC_CustomControl_BETA, AC_P),
    ...
    // @Range{Sub}: 0.0 6.000
    // @User: Standard    
    AP_SUBGROUPINFO(_p_angle_yaw2, "ANG_YAW_", 3, AC_CustomControl_BETA, AC_P),
    ...
    // @Increment: 0.5
    // @User: Advanced
    AP_SUBGROUPINFO(_pid_atti_rate_roll, "RAT_RLL_", 4, AC_CustomControl_BETA, AC_PID),
    ...
    // @Increment: 0.5
    // @User: Advanced
    AP_SUBGROUPINFO(_pid_atti_rate_pitch, "RAT_PIT_", 5, AC_CustomControl_BETA, AC_PID),
    ...
    // @Increment: 0.5
    // @User: Advanced
    AP_SUBGROUPINFO(_pid_atti_rate_yaw, "RAT_YAW_", 6, AC_CustomControl_BETA, AC_PID),

    AP_GROUPEND
};

AC_CustomControl_BETA::AC_CustomControl_BETA(AC_CustomControl& frontend, AP_AHRS_View*& ahrs, AC_AttitudeControl_Multi*& att_control, AP_MotorsMulticopter*& motors, float dt) :
    ...
    _pid_atti_rate_yaw(AC_ATC_MULTI_RATE_YAW_P * 0.90f, AC_ATC_MULTI_RATE_YAW_I * 0.90f, AC_ATC_MULTI_RATE_YAW_D * 0.90f, 0.0f, AC_ATC_MULTI_RATE_YAW_IMAX * 0.90f, AC_ATC_MULTI_RATE_RP_FILT_HZ * 0.90f, AC_ATC_MULTI_RATE_YAW_FILT_HZ * 0.90f, 0.0f, dt)
{
    ...
    printf("BETA.cpp AC_CustomControl_BETA \n");
}

Vector3f AC_CustomControl_BETA::update()
{
...
void AC_CustomControl_BETA::reset(void)
{
