...
struct ExtY_arduAttCont_T {
  real32_T Out1[3];                    /* '<Root>/Out1' */
  real32_T output_tester_body[3];      /* '<Root>/output_tester_body' */
  real32_T output_tester_target[3];    /* '<Root>/output_tester_target' */
};

/* Parameters (default storage) */
struct P_arduAttCont_T_ {
  ...
  real32_T rollratePIDController_N;   /* Mask Parameter: rollratePIDController_N
                                       ...
                                       */
  real32_T pitchratePIDController_N; /* Mask Parameter: pitchratePIDController_N
...
class arduAttCont final
{
 ...
 public:
  ...
  RT_MODEL_arduAttCont_T * getRTM();

  /* Root inports set method */
  void setExternalInputs(const ExtU_arduAttCont_T *pExtU_arduAttCont_T)
  {
    arduAttCont_U = *pExtU_arduAttCont_T;
  }

  /* Root outports get method */
  const ExtY_arduAttCont_T &getExternalOutputs() const
  {
    return arduAttCont_Y;
  }
 ...
 private:
  /* External inputs */
  ExtU_arduAttCont_T arduAttCont_U;

  /* External outputs */
  ExtY_arduAttCont_T arduAttCont_Y;
